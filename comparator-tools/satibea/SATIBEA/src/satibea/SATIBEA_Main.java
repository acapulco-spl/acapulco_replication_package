 ...
 * @author chris
 */
@Command(name = "satibea", mixinStandardHelpOptions = true, 
description = "Runs the satibea tool for feature model optimisation.")
public class SATIBEA_Main extends AbstractExecutor {
	...
	public void run() {
        ...
        try {
			...
			ToolInstrumenter toolInstrumenter = new ToolInstrumenter(p.getNumberOfObjectives(), p.getNumberOfConstraints(), "SATIBEA", "satibea-results", 1);
