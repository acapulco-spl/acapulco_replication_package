...
public class SATIBEA_BinarySolution extends BinarySolutionType {
    ...
    public SATIBEA_BinarySolution(Problem problem, int nFeat, String fm, List<Integer> mandatoryFeaturesIndices, List<Integer> deadFeaturesIndices,List<Integer> seed) throws ClassNotFoundException {
        super(problem);
        this.fm = fm;
        this.nFeat = nFeat;
