...
class ActivationDiagToRuleConverter {
	...
	private static def void addPreserveNode(Rule rule, EClass type, boolean activate, Set<VBRuleFeature> pcComponents, boolean isRoot) {
		if(type === null) {
