 ...
 * @generated
 */
public class MDEOptimiser4EFMSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MDEOptimiser4EFMPackage.QUALITY_ATTRIBUTE_ANNOTATION: {
			QualityAttributeAnnotation qualityAttributeAnnotation = (QualityAttributeAnnotation) theEObject;
			T result = caseQualityAttributeAnnotation(qualityAttributeAnnotation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case MDEOptimiser4EFMPackage.GROUP_FEATURE: {
			...
			if (result == null)
				result = caseFeature(groupFeature);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MDEOptimiser4EFMPackage.QUALITY_ATTRIBUTES_MODEL: {
			QualityAttributesModel qualityAttributesModel = (QualityAttributesModel) theEObject;
			T result = caseQualityAttributesModel(qualityAttributesModel);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Quality Attribute Annotation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Quality Attribute Annotation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQualityAttributeAnnotation(QualityAttributeAnnotation object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Quality Attributes Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Quality Attributes Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQualityAttributesModel(QualityAttributesModel object) {
		return null;
	}
